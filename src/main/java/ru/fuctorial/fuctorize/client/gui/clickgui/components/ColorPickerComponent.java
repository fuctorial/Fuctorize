...
public class ColorPickerComponent extends Component {
    ...
    private boolean hueDragging, sbDragging;  
    ...
    public void drawComponent(int mouseX, int mouseY, double animFactor) {
        ...
        Gui.drawRect(pickerX - 2, pickerY - 2, pickerX + 2, pickerY + 2, shadowColor);  
        Gui.drawRect(pickerX - 1, pickerY - 1, pickerX + 1, pickerY + 1, pointerColor);  

        int hueY = (int)((parent.y + y + 2) + hsb[0] * (height - 4));
        Gui.drawRect(parent.x + x + width - 16, hueY - 2, parent.x + x + width - 2, hueY + 2, shadowColor);  
        Gui.drawRect(parent.x + x + width - 15, hueY - 1, parent.x + x + width - 3, hueY + 1, pointerColor);  
    }
